...
# README - Arquivos no Projeto "Conceitual_unifortes"
...
1. Conceitual_unifortes.brM3 (foto em formato PDF do modelo conceitual):
...
2. Conceitual_unifortes.xml (código do brmodelo conceitual):
...
3. unifortes.pdf (PDF do Power Architect):
...
4. unifortes.sql (SQL feito no PostgreSQL):
...
6. unifortes22.architect~ (Power Architect código):
...
Certifique-se de analisar cada arquivo com atenção para entender seu conteúdo real e seu propósito dentro do projeto "Conceitual_unifortes".
